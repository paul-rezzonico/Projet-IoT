...
public class DisplayController
{
    ...
    private void GenerateLayout(DisplayScreen screen)
    {
        ...
        networkIcon = new Picture(screen.Width - disconnectedImage.Width, 0, disconnectedImage.Width,
            disconnectedImage.Height, disconnectedImage);
    ...
    private void UpdateDisplay()
    {
        ...
        if (screen != null)
        {
            if (displayTempLabel is null || networkIcon is null || connectedImage is null || disconnectedImage is null)
            {
                return;
            }
